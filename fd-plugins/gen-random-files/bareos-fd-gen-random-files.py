...
# BareosFdPluginGenRandomFiles. The plugin argument 'filename' is used to read
...
import BareosFdPluginGenRandomFiles
...
def load_bareos_plugin(plugindef):
    ...
    BareosFdWrapper.bareos_fd_plugin_object = (
        BareosFdPluginGenRandomFiles.BareosFdPluginGenRandomFiles(plugindef)
    )
